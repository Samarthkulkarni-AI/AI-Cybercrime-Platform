...
def user_dashboard(request):
    ...
    safety_tips = [
        ...
        "Install apps only from official stores like Google Play or App Store.",
        "Review app permissions before installing any app.",
        "Verify the sender before responding to emails or calls.",
        "Never give remote access to your device unless absolutely necessary.",
        "Do not share screenshots of your banking apps or transactions.",
        "Keep your mobile's screen lock enabled at all times.",
        "Enable ‘Find My Device’ to track and lock your phone if lost.",
        "Delete apps you no longer use.",
        "Clear browser cookies and history regularly.",
        "Use antivirus or anti-malware software.",
        "Be careful when scanning QR codes from unknown sources.",
        "Avoid posting your location in real time online.",
        "Use Incognito/Private mode on shared devices.",
        "Do not reuse passwords across multiple services.",
        "Check your accounts’ login history for suspicious logins.",
        "Turn on login alerts for email, banking, and social media.",
        "Think before forwarding messages—verify facts.",
        "Be cautious when using file-sharing apps or websites.",
        "Avoid saving passwords on shared or public devices.",
        "Always verify unknown phone numbers through official channels.",
        "Do not respond to threats or blackmail messages—report them.",
        "Be extra cautious of job offers asking for fees or personal details.",
        "Use secure cloud storage with encryption enabled.",
        "Review privacy settings of your social accounts regularly.",
        "Shred or destroy documents with personal information before disposal.",
        "Do not store sensitive data like passwords in plain text files.",
        "Always double-check URLs for fake or misspelled domains.",
        "If a deal looks too good to be true, it probably is.",
        "Report cyber fraud immediately to cybercrime.gov.in."
    ]
